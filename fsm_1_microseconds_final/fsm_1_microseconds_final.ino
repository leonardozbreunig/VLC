...
#define LIMITE_LUZ 2  //valor entre 0 e 1023 para separar entre nivel alto e baixa
#define TAMANHO_DADO 4 //tamanho do pacote
#define TAMANHO_PACOTE (2*TAMANHO_DADO)
#define TEMPO 2000 //indica o tempo em us
#define PIN_LED 3

int limite_luz=2,media=0,repete=0,umBit=0,enviados=0,total=0,certos=0,errados=0;    //CALIBRAÇÃO, adicionei media e limite_luz  //contador do laço do transmissor de não enviar dados
...
//  interrupts();
  ...
  if((total==1000)or(enviados==1000)){
  Serial.print("T ");
