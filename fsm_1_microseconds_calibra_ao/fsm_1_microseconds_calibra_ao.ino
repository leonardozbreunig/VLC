...
int limite_luz=2,media=0,repete=0,total=0,certos=0,errados=0;    //CALIBRAÇÃO, adicionei media e limite_luz  //contador do laço do transmissor de não enviar dados
...
int dadoT[TAMANHO_DADO]={0,1,1,0};
